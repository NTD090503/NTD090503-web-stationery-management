...
<body>
    ...
    ?>
    <div class = "container">
        <form METHOD = "post" action="/live/mvc/controllers/TestAPIPUT.php">
            <h1>Edit Account NV</h1>

            <div class="form-control error">
            <label for="id">ID NV</label>
                <input id ="id"  name = "id" type="text" value ="<?php echo($data["id_nhanvien"])?> "placeholder ="ID NV" >
                <span></span>
                <small></small>
            </div>
            <div class="form-control error">
           ...
           <div class="form-control">
            ...
            <div class="signup-link">
                 <a href="/live/NhanVien/Show">Trở về</a>
            </div>
            <script>
    function goBack() {
        window.history.back();
...
function submitForm() {
    ...
    $.ajax({
        url: "/live/mvc/controllers/TestAPIPUT.php",
        method: "PUT",
        data: {
            action: "update",
