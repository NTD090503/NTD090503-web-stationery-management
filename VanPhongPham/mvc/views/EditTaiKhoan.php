...
<?php
    ...
    ?>
    <div class = "container">
        <form METHOD = "post" action = "/VanPhongPham/mvc/controllers/Test_API/TaiKhoan/TestAPIPUT.php">
            <h1>Edit Accout</h1>
...
function submitForm() {
    ...
    $.ajax({
        url: "/VanPhongPham/mvc/controllers/Test_API/TaiKhoan/TestAPIPUT.php",
        method: "PUT",
        data: {
            action: "update",
