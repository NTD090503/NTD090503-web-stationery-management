                ...
                <div class="tile">
                    ...
                    <div class='row element-button'>
                        <div class='col-sm-2' style="display: flex; gap: 10px;" >
                          <a class='btn btn-add btn-sm' href='/VanPhongPham/TaiKhoan/addTK' title='Thêm'><i class='fas fa-plus'></i>
                            Thêm Tài khoản</a>
                            <br>
                            <br>
                            <a class='btn btn-add btn-sm' href='/VanPhongPham/TaiKhoan/SearchTK' title='Tìm'><i class='fas fa-plus'></i>
                            Tìm kiếm </a>
                            <br>
                            <br>
                            ...
                            <br>
                            <br>
                            <a class='btn btn-add btn-sm' href='/VanPhongPham/TaiKhoan/sapxepTK' title='Tìm'><i class='fas fa-plus'></i>
                            Sắp xếp </a>
                        </div>
                ...
                echo"<table id='customers'>";
                    ...
                    <tbody>";
                        while($row = mysqli_fetch_assoc($data["TK"])){
                            ...
                            echo "<td> <a href='/VanPhongPham/TaiKhoan/editTK/".$row["id_taikhoan"]."'class='btn btn-edit ' type='button' title='Sửa'> 
                            <i class=''>Sửa</i> </a>
                            <a href='/VanPhongPham/TaiKhoan/deletetk/".$row["id_taikhoan"]."'
