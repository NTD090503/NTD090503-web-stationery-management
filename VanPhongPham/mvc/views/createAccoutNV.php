...
// //include(__DIR__ . '/../controllers/APIHandler.php'); // Sử dụng đường dẫn tuyệt đối
...
<body>
    <div>
<div class = "container">
        <form METHOD = "post" action = "/VanPhongPham/mvc/controllers/Test_API/TaiKhoan/TestAPIPost.php">
    ...
    <select id="quyen" name="quyen">
        ...
        <option value="nhanvien">KH</option>
    </select>
    <span></span>
    <small></small>
</div>
...
<button class="btn-submit" name = "btnsubmit" onclick="dangky()">Create</button>
            ...
            <div class="signup-link">
                 <a href="/VanPhongPham/Home/Show">Trở về</a>
            </div>
        </form>
    </div>
    <div>
